...
const products: SeedProduct[] = [
  ...
  },
  {
    ...
    category: "almonds",
    image: "almonds",
    tags: ["almonds", "mamra", "badam", "premium", "afghan"],
    short: "Rare, oil-rich Mamra almonds — smaller, denser and more nutritious than regular almonds.",
    description:
      "Mamra almonds are a premium variety grown in limited quantities, prized for their higher natural oil content, denser texture and richer flavour compared to regular California almonds.\n\nBest enjoyed soaked overnight or eaten raw to get the most of their nutrition.",
  ...
  {
    name: "Cashew Nut Pieces (Broken)",
    slug: "cashew-nut-pieces-broken",
    sku: "SP-CSH-BRK",
    category: "cashews",
    image: "cashews",
    tags: ["cashews", "kaju", "broken", "pieces", "value pack"],
    short: "Budget-friendly broken cashew pieces — same great taste, ideal for cooking and baking.",
    description: "Broken cashew pieces cost less than whole cashews but taste just as good. Perfect for gravies, sweets, baking and everyday snacking where appearance doesn't matter.",
    ingredients: "Cashew kernels (broken pieces)",
    allergens: "Contains tree nuts (cashews).",
    basePrice100g: 99,
  ...
  },
  {
    ...
    category: "walnuts",
    image: "walnuts",
    tags: ["walnuts", "akhrot", "kashmiri", "in-shell", "whole"],
    short: "Whole in-shell walnuts from Kashmir with a thin shell and light, sweet kernel.",
    description: "Sourced from Kashmir, these walnuts have thin, easy-to-crack shells and a light-coloured, sweet-tasting kernel inside. Sold whole (in-shell) for maximum freshness.",
    ingredients: "Walnuts (in-shell)",
    allergens: "Contains tree nuts (walnuts).",
    basePrice100g: 149,
    weights: [500, 1000],
  },
  {
    ...
    category: "raisins",
    image: "raisins",
    tags: ["raisins", "kishmish", "golden raisins", "green"],
    short: "Light, tangy-sweet golden raisins — a lighter alternative to black raisins.",
    description: "Golden raisins have a slightly tangier, lighter taste than black raisins. Great in salads, rice dishes (pulao), baking, and as a healthy snack.",
  ...
  },
  {
    ...
    category: "dates",
    image: "dates",
    tags: ["dates", "khajur", "medjool", "premium"],
    short: "Large, soft, caramel-sweet Medjool dates — often called the \"king of dates\".",
    description: "Medjool dates are larger, softer and sweeter than regular dates, with a rich caramel-like flavour. Enjoy on their own, stuffed with nuts, or as a natural sugar substitute in recipes.",
  ...
  {
    name: "Diwali Special Dry Fruit Box",
    slug: "diwali-special-dry-fruit-box",
    sku: "SP-GFT-DWL",
    category: "gift-hampers",
    image: "gift-hampers",
    tags: ["gift", "diwali", "festival", "hamper"],
    short: "A festive assortment of almonds, cashews, pistachios and dates in a Diwali-themed box.",
    description: "Celebrate Diwali with a beautifully packed assortment of our best-selling dry fruits. A thoughtful gift for family, friends, neighbours and colleagues this festive season.",
  ...
  },
  {
    ...
    category: "gift-hampers",
    image: "gift-hampers",
    tags: ["gift", "corporate", "bulk", "hamper", "office"],
    short: "An elegant, professional dry fruit hamper suited for corporate gifting and bulk orders.",
    description: "A tastefully presented hamper of premium dry fruits, ideal for corporate gifting to clients, employees and business partners. Available for bulk orders — reach out via our B2B page for volume pricing.",
    ingredients: "Almonds, cashews, walnuts, raisins",
    allergens: "Contains tree nuts (almonds, cashews, walnuts).",
    basePrice100g: 199,
    weights: [500, 1000],
  },
];
